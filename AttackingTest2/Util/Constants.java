...
public class Constants {
	...
	public static final int RUNAWAY_RADIO_CHANNEL = MEDBAY_CLAIMED_RAD_CHAN + 1;
	public static final int ENC_CLAIM_RAD_CHAN_START = RUNAWAY_RADIO_CHANNEL + 1;// NUM_ENC_TO_CLAIM channels
